...
**Chi tiết tra bảng cho P1 (minh họa):**

- price=148 (≤250): Q=5, E=10
- mpix=8.0 (≤8): Q=4, E=10
- opt-zoom=4× (≤9): Q=6, E=9
- LCD=2.5 (≤2.7): Q=6, E=10
- movies=no: Q=3, E=10
- sound=no: Q=7, E=10
- waterproof=yes: Q=10, E=6

→ P1: ΣQ = 5+4+6+6+3+7+10 = **41**, ΣE = 10+10+9+10+10+10+6 = **65**

*(Các sản phẩm khác tính tương tự, kết quả như bảng trên)*

**Bước 2: Tính utility cho Cu1 = 0.8×Q + 0.2×E**

| P | 0.8×Q | 0.2×E | Utility |
|---|-------|-------|---------|
| P1 | 32.8 | 13.0 | **45.8** |
| P2 | 39.2 | 12.8 | **52.0** |
| P3 | 42.4 | 12.2 | **54.6** |
...
**Bước 1 & 2: Tính utility cho Cu2 = 0.4×Q + 0.6×E**

| P | 0.4×Q | 0.6×E | Utility |
|---|-------|-------|---------|
| P1 | 16.4 | 39.0 | **55.4** |
| P2 | 19.6 | 38.4 | **58.0** |
| P3 | 21.2 | 36.6 | **57.8** |
